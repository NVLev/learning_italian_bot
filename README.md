...
- [Aiogram](https://github.com/aiogram/aiogram) - отличный async фреймворк для Telegram ботов
- [OpenAI](https://openai.com/) - за мощный GPT-4 API
- [SQLAlchemy](https://www.sqlalchemy.org/) - лучший Python ORM

---

## 📸 Скриншоты

> TODO: Добавить скриншоты интерфейса бота
